        ...
        <div className="lg:col-span-2 bg-white/70 backdrop-blur-sm border-white/20 rounded-lg p-6 hover:shadow-xl transition-all duration-300">
            ...
            {filteredData.length > 0 && (
                <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-[#F2F1EF] border border-black p-3 rounded-lg">
                        <div className="text-sm bg-gradient-to-r from-black via-gray-700 to-gray-500 bg-clip-text text-transparent font-medium">Total Reductions</div>
            ...
            {filteredData.length > 0 && (
                <div className="mt-4 p-4 bg-[#F2F1EF] border border-black rounded-lg">
                    <h4 className="text-sm font-semibold bg-gradient-to-r from-black via-gray-700 to-gray-500 bg-clip-text text-transparent mb-2">Price Reduction Analysis</h4>
